...
instructions:
  - time:
    ...
    ingredients:
      ...
      - name: 'Kosher salt'
        amount: 'As needed'
      - name: 'Fresh ground cracked pepper'
        amount: 'As needed'
      - name: 'Chipotle or tomato paste'
        amount: '2 tsp'
    procedure:
  ...
  - time:
    ...
    procedure:
      ...
      - 'Cook at 9 PSI for 15 minutes then release pressure.'
      - 'Remove the bouquet garni, stir soup together, season with salt and pepper, and serve'
---
