---
title: 'Brown Butter, Sage, and Wild Mushroom Dressing'
  ...
  - time:
    ...
    ingredients:
      ...
      - name: 'Dried porcini mushrooms'
        amount: '5'
    procedure:
      - 'Add mushroom stock and dried mushrooms into a saucepan and bring to a simmer for 15 minutes. Once done, remove from the heat and discard the dried mushrooms'
  - time:
      active: '15 minutes'
    equipment:
      - 'Large skillet'
    ingredients:
      ...
      - name: 'Large yellow onion'
        amount: '1'
      - name: 'Thyme, finely shopped'
        amount: '2 tbsp'
      - name: 'Sage, finely chopped'
        amount: '3 tbsp'
      - name: 'Garlic'
        amount: '5 cloves'
    ...
    procedure:
      ...
      - 'Heat a large skillet over medium-high heat, add butter, and sauté onions until they become translucent, about 4 minutes'
      - 'Add garlic, thyme, and sage, and cook until fragrant, about 1 minute'
      - 'Add mushrooms, salt and pepper, and cook until mushrooms have given up most of their water and are soft and caramelized'
      - 'Add fortified mushroom stock and bring to a simmer'
  - time:
      active: '5 minutes'
    equipment:
      - 'Large bowl'
    ingredients:
      - name: 'Potato bread, cut into bite-sized cubes'
        amount: '570g'
      - name: 'Large eggs'
        amount: '2'
    procedure:
      - 'Lightly beat both eggs'
      - 'In a large bowl, combine mushrooms mixture, stuffing cubes, and eggs together and mix. The dressing should be very wet. Add more mushroom stock as needed'
  - time:
      active: '5 minutes'
      inactive: '60 minutes'
      rest: '10 minutes'
    equipment:
      ...
      - 'Medium saucepan'
    ingredients:
      - name: 'Unsalted butter, plus more for greasing'
        amount: '4 tbsp'
    procedure:
      - 'Grease the baking dish, then scrape the dressing mixture into the dish'
      - 'Melt the 4tbsp butter in a medium saucepan over medium-high heat Cook, gently swirling pan constantly, until particles begin to turn golden brown and butter smells nutty, about 5 minutes. Remove from heat and continue swirling the pan until the butter is a rich brown, about 15 seconds longer. Pour evenly over the dressing mixture'
      - 'Cover with aluminum foil and bake for 50-60 minutes until the top is golden brown, removing the foil after 20 minutes'
