...
instructions:
  - time:
    ...
    ingredients:
      - name: '1.5-2lb live main lobster'
        amount: '2'
      - name: 'Water'
        amount: 'As needed'
      - name: 'Kosher salt'
        amount: 'As needed'
    procedure:
      - 'Place live lobster in freezer while water comes to boil, about 10-15 minutes'
  ...
  - time:
    ...
    ingredients:
      - name: 'Dried radiatore or cascatelli pasta'
        amount: '8oz'
    procedure:
  ...
  - time:
    ...
    equipment:
      - 'Oven-safe ramekins or porcelain bakers'
    ingredients:
