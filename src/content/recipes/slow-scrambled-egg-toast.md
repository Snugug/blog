...
instructions:
  - time:
    ...
    procedure:
      ...
      - 'Crack the eggs into a bowl, add the salt, and whisk together until whites and yolks are well combined.'
  ...
  - time:
      ...
      inactive: '5 minutes'
    ingredients:
      - name: 'Thick-cut brioche or sourdough loaf'
        amount: '2 slices'
      ...
      - name: 'Fresh ground black pepper'
        amount: 'As needed'
    procedure:
      - 'Toast the bread, then add 1/2 of the eggs on top (they should be gooey and stay in placed when added, even spreadable), and top with scallion greens and black pepper, to taste.'
---
